...
class deployRecord(models.Model):
    ...
    projectOwner = models.CharField(blank=True, max_length=200, verbose_name="项目负责人")
    ...
    testStatus = models.CharField(blank=True,max_length=200, verbose_name="测试状态 0-测试未通过 1-测试通过")
    aduitStatus = models.CharField(blank=True,max_length=200, verbose_name="审核状态 0-审核未通过 1-审核通过")
    aduitResult = models.CharField(blank=True,max_length=200, verbose_name="审核拒绝的原因 项目经理填写")
    onlineTestResult = models.CharField(blank=True, max_length=200, verbose_name="正式环境测试结论")
    onlineTestStatus = models.CharField(blank=True, max_length=200, verbose_name="正式环境测试状态 0-测试未通过 1-测试通过")
