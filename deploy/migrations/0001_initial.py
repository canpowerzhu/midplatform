# -*- coding: utf-8 -*-
# Generated by Django 1.11.14 on 2020-07-26 19:53
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('state', models.IntegerField(choices=[(0, '未处理'), (1, '失败'), (2, '成功')], verbose_name='更新进度 0- 未处理，1- 处理中，2-失败 ，3-成功')),
                ('publisher', models.CharField(max_length=500, verbose_name='发布负责人')),
                ('isModifyCache', models.IntegerField(choices=[(0, '未修改'), (1, '修改')], default=0, verbose_name='是否修改缓存')),
                ('cacheDetail', models.TextField(blank=True, max_length=1024, verbose_name='修改缓存详情')),
                ('isModifySql', models.IntegerField(choices=[(0, '未修改'), (1, '修改')], default=0, verbose_name='是否修改数据库')),
