# -*- coding: utf-8 -*-
# Generated by Django 1.11.14 on 2020-05-23 16:38
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('perssion', models.CharField(max_length=300, verbose_name='菜单权限标识')),
                ('path', models.CharField(max_length=300, verbose_name='路由URL')),
                ('router_name', models.CharField(max_length=300, verbose_name='路由名称')),
                ('component', models.CharField(max_length=300, verbose_name='component地址')),
                ('redirect', models.CharField(max_length=300, verbose_name='重定向地址')),
                ('target', models.CharField(max_length=300, verbose_name='连接跳转目标')),
                ...
                ('keep_alive', models.IntegerField(choices=[(0, '关闭'), (1, '开启')], verbose_name='0-关闭，1- 开启')),
                ('type', models.IntegerField(choices=[(0, '菜单'), (1, '按钮')], verbose_name='菜单类型 （0-菜单 1-按钮')),
                ('hidden', models.IntegerField(choices=[(0, '否'), (1, '是')], verbose_name='是否隐藏路由: 0-否,1-是')),
                ('del_flag', models.IntegerField(choices=[(0, '删除'), (1, '正常')], verbose_name='逻辑删除 0-删除， 1-正常')),
                ('create_time', models.DateTimeField(auto_now=True, verbose_name='创建时间')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gender', models.IntegerField(choices=[(0, 'Male'), (1, 'Female')], verbose_name='头像')),
                ...
                ('del_flag', models.IntegerField(choices=[(0, 'normal'), (1, 'deleted')], db_index=True, verbose_name='删除状态，锁定 正常')),
