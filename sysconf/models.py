...
class sys_menu(models.Model):
    ...
    name = models.CharField(null=True,max_length=300, verbose_name='菜单name')
    title = models.CharField(max_length=300, verbose_name='菜单title')
    perssion = models.CharField(null=True,max_length=300, verbose_name='权限')
    parent_id = models.IntegerField(verbose_name='父级菜单ID')
    icon = models.CharField(null=True,max_length=120, verbose_name='图标')
    jump = models.CharField(null=True,max_length=300, verbose_name='路径')
    sort = models.IntegerField(null=True, verbose_name='排序值，用于菜单排序')
    keep_alive = models.NullBooleanField(null=True, default=True,verbose_name='0-关闭，1- 开启')
    hidden = models.NullBooleanField(null=True, default=False,verbose_name='是否隐藏路由: 0否,1是')
    del_flag = models.NullBooleanField(null=True,default=True,verbose_name='逻辑删除 0-删除， 1-正常')
